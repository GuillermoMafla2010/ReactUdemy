...
class Router extends Component {
     ...
     obtenerPost = () => {
          axios.get(`http://localhost:81/apirest_php/apirestfull/public/api/estudiantes`)
               .then(res => {
                    this.setState({
                         posts: res.data
                    })
     ...
     crearPost = (post) => {
         axios.post(`http://localhost:81/apirest_php/apirestfull/public/api/estudiantes/`,post)
                .then(res => {
                    if(res.status === 201) {
                        swal(
                            'Post Creado',
